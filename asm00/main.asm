...
_LABEL_B51_:	
	...
	.db $05 $00 $39 $7E $F5 $33 $CD $6D $1B $F1 $7D $C1 $02 $3E $03 $F5
	.db $33 $21 $03 $00 $39 $7E $F5 $33 $CD $EE $1E $F1 $4D $21 $27 $C0
	.db $71 $C3 $88 $0D $DD $E5 $DD $21 $00 $00 $DD $39 $F5 $F5 $DD $36
	.db $FD $00 $3E $E0 $DD $86 $FD $DD $77 $FE $3E $11 $CE $00 $DD $77
	.db $FF $0E $00 $69 $29 $09 $7D $DD $86 $FD $5F $21 $DC $11 $06 $00
	.db $09 $46 $DD $6E $FE $DD $66 $FF $7E $DD $77 $FC $26 $00 $6B $29
	.db $11 $56 $C1 $19 $5E $23 $56 $DD $7E $FC $DD $86 $04 $C5 $F5 $33
	...
	.db $F1 $F1 $D1 $C1 $79 $C6 $08 $DD $77 $FD $C5 $D5 $21 $21 $01 $E5
	.db $C5 $33 $DD $7E $FD $F5 $33 $CD $64 $09 $F1 $F1 $D1 $C1 $79 $C6
	.db $10 $DD $77 $FF $C5 $D5 $21 $22 $01 $E5 $C5 $33 $DD $7E $FF $F5
	.db $33 $CD $64 $09 $F1 $F1 $D1 $C1 $79 $C6 $18 $DD $77 $FC $C5 $D5
	.db $21 $23 $01 $E5 $C5 $33 $DD $7E $FC $F5 $33 $CD $64 $09 $F1 $F1
	...
	.db $2D $01 $E5 $D5 $33 $DD $7E $FD $F5 $33 $CD $64 $09 $F1 $F1 $D1
	.db $D5 $21 $2E $01 $E5 $D5 $33 $DD $7E $FF $F5 $33 $CD $64 $09 $F1
	.db $F1 $D1 $D5 $21 $2F $01 $E5 $D5 $33 $DD $7E $FC $F5 $33 $CD $64
	...
	.db $0D $01 $DC $11 $21 $26 $C0 $6E $26 $00 $09 $4E $11 $E0 $11 $21
	...
	.db $C1 $21 $B8 $17 $6E $26 $00 $06 $00 $09 $E5 $CD $4C $09 $F1 $DD
	...
	.db $33 $D5 $33 $CD $23 $09 $F1 $C1 $21 $B8 $17 $5E $16 $00 $78 $6F
	...
	.db $05 $E5 $CD $65 $1B $F1 $F1 $5D $54 $E5 $D5 $01 $0A $00 $C5 $DD
	.db $4E $04 $DD $46 $05 $C5 $CD $FA $1E $F1 $F1 $45 $D1 $E1 $DD $75
...
+:	
	...
	; Data from 10D8 to 16DC (1541 bytes)
	.incbin "data/File00_010D8_016DC.dat"
	
; Data from 16DD to 17A7 (203 bytes)	
_DATA_16DD_:	
...
; Data from 17A8 to 1BA5 (1022 bytes)	
_DATA_17A8_:	
...
; Data from 1C69 to 1C7B (19 bytes)	
_DATA_1C69_:	
...
_LABEL_1E1A_:	
	...
	.db $6B $C0 $FD $7E $00 $A1 $6F $FD $7E $01 $A0 $67 $C9 $3A $6B $C0
	.db $FD $21 $6D $C0 $FD $A6 $00 $6F $3A $6C $C0 $FD $21 $6D $C0 $FD
	.db $A6 $01 $67 $C9 $FD $21 $6B $C0 $FD $7E $00 $2F $4F $FD $7E $01
...
_LABEL_1E77_:	
	...
	; Data from 1E7D to 1EA4 (40 bytes)
...
+:	
	...
	; Data from 2241 to 7FEF (23983 bytes)
	.dsb 23883, $00
	.db $56 $61 $6E $20 $48 $61 $6C $65 $6E $20 $52 $65 $63 $6F $72 $64
	.db $20 $43 $6F $76 $65 $72 $73 $20 $66 $6F $72 $20 $74 $68 $65 $20
	.db $53 $4D $53 $20 $50 $6F $77 $65 $72 $21 $20 $32 $30 $32 $31 $20
