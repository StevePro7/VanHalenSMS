...
S:Ltitle_screen.screen_title_screen_load$ro$1$28({2}DG,STtag_struct_record_object:S),R,0,0,[]
S:Ltitle_screen.screen_title_screen_load$storage$1$28({1}SC:U),R,0,0,[l]
F:G$screen_title_screen_update$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Ltitle_screen.screen_title_screen_update$screen_type$1$30({2}DG,SC:U),B,1,4
S:Ltitle_screen.screen_title_screen_update$delay$1$31({1}SC:U),B,1,-3
S:Ltitle_screen.screen_title_screen_update$input$1$31({1}SC:U),R,0,0,[l]
