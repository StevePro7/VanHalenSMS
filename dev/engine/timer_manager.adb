...
S:Ltimer_manager.engine_reset_manager_load$ro$1$8({2}DG,STtag_struct_reset_object:S),R,0,0,[c,b]
...
S:Ltimer_manager.engine_reset_manager_update$test$1$9({1}SC:U),R,0,0,[d]
