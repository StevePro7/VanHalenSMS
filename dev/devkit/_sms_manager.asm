...
;_sms_manager.c:156: return SMS_getKeysStatus();
	...
	.globl	C$_sms_manager.c$160$1$122
...
;_sms_manager.c:162: return SPRITEMODE_NORMAL;
	ld	l, #0x00
	C$_sms_manager.c$163$1$123	= .
	.globl	C$_sms_manager.c$163$1$123
	...
	.globl	C$_sms_manager.c$164$1$123
...
;_sms_manager.c:166: return VDPFEATURE_HIDEFIRSTCOL;
	ld	hl, #0x0020
	C$_sms_manager.c$167$1$124	= .
	.globl	C$_sms_manager.c$167$1$124
	...
	.globl	C$_sms_manager.c$168$1$124
...
;_sms_manager.c:170: return TILE_PRIORITY;
	...
	.globl	C$_sms_manager.c$171$1$125
	...
	.globl	C$_sms_manager.c$172$1$125
...
;_sms_manager.c:174: return TILE_USE_SPRITE_PALETTE;
	...
	.globl	C$_sms_manager.c$175$1$126
